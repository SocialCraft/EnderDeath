...
public class Round {
	...
	public void start(){
		taskId = Bukkit.getScheduler().scheduleSyncDelayedTask(plugin, new RoundTimer(this), 20);
	}
	public void tick() {
		time--;
		if (time <= 0){
	...
	public String[] getFormattedScore(){
		return new String[]{team1.getTeamName() + ":" + team1.getScore(), team2.getTeamName() + ":" + team2.getScore()};
	}
}
